...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_UPD_GUILD_MEMBER_RANKS,
    CHAR_UPD_GUILD_MEMBER_ROSTER_INFO,
    CHAR_UPD_GUILD_MOTD,
    CHAR_UPD_GUILD_INFO,
    CHAR_UPD_GUILD_LEADER,
    CHAR_UPD_GUILD_RANK_NAME,
    CHAR_UPD_GUILD_RANK_RIGHTS,
    CHAR_UPD_GUILD_RANKS,
    ...
    CHAR_UPD_GUILD_BANK_RANK_RIGHTS,
    ...
    CHAR_UPD_GUILD_MEMBER_RESET_WEEK_ADVANCEMENT,
    CHAR_UPD_GUILD_MEMBER_REPUTATION,
