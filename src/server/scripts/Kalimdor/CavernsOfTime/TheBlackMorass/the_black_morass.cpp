...
public:
    ...
    struct npc_time_riftAI : public ScriptedAI
    {
        ...
        void DoSelectSummon()
        {
            ...
            TC_LOG_INFO("scripts", "npc_time_rift: summoning wave Creature (Wave %u, Entry %u).", mRiftWaveCount, entry);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            TC_LOG_INFO("scripts", "npc_time_rift: not casting anylonger, i need to die.");
