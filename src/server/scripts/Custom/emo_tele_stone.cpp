...
class custom_emo_tele_stone : public ItemScript
{
public:
    custom_emo_tele_stone() : ItemScript("custom_emo_tele_stone") { }
	...
	bool OnGossipSelect(Player* pPlayer, Creature* pCreature, uint32 /*uiSender*/, uint32 uiAction)
	{
		...
		// pPlayer->ModifyMoney(-1 * pandariq[uiAction].cost);
...
void AddSC_custom_emo_tele_stone() // Add to scriptloader normally
{
    new custom_emo_tele_stone();
}
