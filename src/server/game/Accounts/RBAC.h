...
class RBACData
{
    public:
         ...
         *     TC_LOG_INFO("entities.player", "Failed to grant permission %u, already denied", permissionId);
         * @endcode
         */
         ...
         *     TC_LOG_INFO("entities.player", "Role Id %u does not exists", permissionId);
         * @endcode
         */
         ...
         *     TC_LOG_INFO("entities.player", "Permission %u succesfully removed", permissionId);
         * @endcode
         */
