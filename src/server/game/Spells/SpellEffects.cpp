...
{
    TC_LOG_INFO("spells", "WORLD: Spell Effect DUMMY");
}
...
void Spell::EffectInstaKill(SpellEffIndex /*effIndex*/)
{
    ...
    WorldPacket data(SMSG_SPELL_INSTAKILL_LOG, 4);
...
void Spell::EffectDummy(SpellEffIndex effIndex)
{
    ...
    TC_LOG_INFO("spells", "Spell ScriptStart spellid %u in EffectDummy(%u)", m_spellInfo->Id, effIndex);
...
void Spell::EffectTriggerSpell(SpellEffIndex effIndex)
{
    ...
    if (!spellInfo)
    {
        TC_LOG_INFO("spells", "Spell::EffectTriggerSpell spell %u tried to trigger unknown spell %u", m_spellInfo->Id, triggered_spell_id);
        return;
    }
...
void Spell::EffectTriggerMissileSpell(SpellEffIndex effIndex)
{
    ...
    if (!spellInfo)
    {
        TC_LOG_INFO("spells", "Spell::EffectTriggerMissileSpell spell %u tried to trigger unknown spell %u", m_spellInfo->Id, triggered_spell_id);
        return;
    }
...
void Spell::EffectTeleportUnits(SpellEffIndex /*effIndex*/)
{
    ...
    TC_LOG_INFO("spells", "Spell::EffectTeleportUnits - teleport unit to %u %f %f %f %f\n", mapid, x, y, z, orientation);
...
void Spell::EffectUnlearnSpecialization(SpellEffIndex effIndex)
{
    ...
    TC_LOG_INFO("spells", "Spell: Player %u has unlearned spell %u from NpcGUID: %u", player->GetGUIDLow(), spellToUnlearn, m_caster->GetGUIDLow());
}
...
void Spell::EffectSendEvent(SpellEffIndex effIndex)
{
    ...
    TC_LOG_INFO("spells", "Spell ScriptStart %u for spellid %u in EffectSendEvent ", m_spellInfo->Effects[effIndex].MiscValue, m_spellInfo->Id);
    ...
    if (unitTarget && unitTarget->IsAlive() && damage >= 0)
    {
        ...
        else if (m_spellInfo->TargetAuraState == AURA_STATE_SWIFTMEND && unitTarget->HasAuraState(AURA_STATE_SWIFTMEND, m_spellInfo, m_caster))
        {
            ...
            if (Unit* auraCaster = targetAura->GetCaster())
                tickheal = auraCaster->SpellHealingBonusDone(unitTarget, targetAura->GetSpellInfo(), tickheal, DOT, effIndex);
...
void Spell::EffectHealthLeech(SpellEffIndex effIndex)
{
    ...
    TC_LOG_INFO("spells", "HealthLeech :%i", damage);
    ...
    if (gameObjTarget)
    {
        ...
        switch (gameObjTarget->GetGoType())
        {
            ...
            case GAMEOBJECT_TYPE_CHEST:
                ...
                {
                    TC_LOG_INFO("spells", "Chest ScriptStart id %u for GO %u", gameObjTarget->GetGOInfo()->chest.eventId, gameObjTarget->GetDBTableGUIDLow());
...
void Spell::EffectOpenLock(SpellEffIndex effIndex)
{
    ...
    if (m_caster->GetTypeId() != TYPEID_PLAYER)
    {
        TC_LOG_INFO("spells", "WORLD: Open Lock - No Player Caster!");
        return;
    }
    ...
    {
        TC_LOG_INFO("spells", "WORLD: Open Lock - No GameObject/Item Target!");
        return;
    }
...
void Spell::EffectLearnSpell(SpellEffIndex effIndex)
{
    ...
    TC_LOG_INFO("spells", "Spell: Player %u has learned spell %u from NpcGUID=%u", player->GetGUIDLow(), spellToLearn, m_caster->GetGUIDLow());
}
...
void Spell::EffectScriptEffect(SpellEffIndex effIndex)
{
    ...
    // normal DB scripted effect
    TC_LOG_INFO("spells", "Spell ScriptStart spellid %u in EffectScriptEffect(%u)", m_spellInfo->Id, effIndex);
    m_caster->GetMap()->ScriptsStart(sSpellScripts, uint32(m_spellInfo->Id | (effIndex << 24)), m_caster, unitTarget);
}
...
void Spell::EffectStuck(SpellEffIndex /*effIndex*/)
{
    ...
    TC_LOG_INFO("spells", "Spell Effect: Stuck");
...
void Spell::EffectTransmitted(SpellEffIndex effIndex)
{
    ...
    TC_LOG_INFO("spells", "AddObject at SpellEfects.cpp EffectTransmitted");
    //m_caster->AddGameObject(pGameObj);
...
void Spell::EffectSkill(SpellEffIndex /*effIndex*/)
{
    ...
    TC_LOG_INFO("spells", "WORLD: SkillEFFECT");
}
...
void Spell::EffectSkinPlayerCorpse(SpellEffIndex /*effIndex*/)
{
    ...
    TC_LOG_INFO("spells", "Effect: SkinPlayerCorpse");
...
void Spell::EffectStealBeneficialBuff(SpellEffIndex effIndex)
{
    ...
    TC_LOG_INFO("spells", "Effect: StealBeneficialBuff");
...
void Spell::EffectBind(SpellEffIndex effIndex)
{
    ...
    TC_LOG_INFO("spells", "EffectBind: New homebind X: %f, Y: %f, Z: %f, MapId: %u, AreaId: %u",
