...
enum TradeStatus
{
    ...
    */
    // Start of the Trade Enum
    TRADE_STATUS_CANCELLED = 0,
    ...
    TRADE_STATUS_COMPLETE = 6,                  // Is correct
    TRADE_STATUS_DEAD = 7,
    TRADE_STATUS_STATE_CHANGED = 8,
    TRADE_STATUS_WRONG_FACTION = 9,
    TRADE_STATUS_ALREADY_TRADING = 10,
    TRADE_STATUS_RESTRICTED_ACCOUNT = 11,
    // TRADE_STATUS_INITIATED = 12,
    // TRADE_STATUS_ACCEPTED = 12,
    TRADE_STATUS_LOGGING_OUT = 13,
    // TRADE_STATUS_PLAYER_IGNORED = 14,
    TRADE_STATUS_ACCEPTED = 14,
    TRADE_STATUS_TARGET_LOGGING_OUT = 15,
    TRADE_STATUS_PETITION = 16,
    TRADE_STATUS_STUNNED = 17,
    TRADE_STATUS_PLAYER_BUSY = 18,
    TRADE_STATUS_WRONG_REALM = 19,
    TRADE_STATUS_NOT_ENOUGH_CURRENCY = 20,
    // TRADE_STATUS_PROPOSED = 21,
    TRADE_STATUS_UNACCEPTED = 22,
    TRADE_STATUS_TARGET_DEAD = 23,
    // TRADE_STATUS_ACCEPTED = 24,
    TRADE_STATUS_PROPOSED = 24,             // Is correct
    TRADE_STATUS_NOT_ON_TAPLIST = 25,
    TRADE_STATUS_FAILED = 26,
    TRADE_STATUS_PLAYER_IGNORED = 27,
    TRADE_STATUS_CURRENCY_ACCEPT = 30,
