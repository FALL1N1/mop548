...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        Creature* GetNPCIfCanInteractWith(uint64 guid, uint64 npcflagmask);
        ...
        */
        ...
        void UpdateAurasOnPowerChange(Powers power);
        ...
        bool SatisfiesGuildGroupCriteria() const;
