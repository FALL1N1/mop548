...
void Vehicle::Uninstall()
{
    ...
    TC_LOG_INFO("entities.vehicle", "Vehicle::Uninstall Entry: %u, GuidLow: %u", _creatureEntry, _me->GetGUIDLow());
    RemoveAllPassengers();
...
void Vehicle::Reset(bool evading /*= false*/)
{
    ...
    TC_LOG_INFO("entities.vehicle", "Vehicle::Reset (Entry: %u, GuidLow: %u, DBGuid: %u)", GetCreatureEntry(), _me->GetGUIDLow(), _me->ToCreature()->GetDBTableGUIDLow());
...
{
    TC_LOG_INFO("entities.vehicle", "Vehicle::RemoveAllPassengers. Entry: %u, GuidLow: %u", _creatureEntry, _me->GetGUIDLow());
...
void Vehicle::InstallAccessory(uint32 entry, int8 seatId, bool minion, uint8 type, uint32 summonTime)
{
    ...
    TC_LOG_INFO("entities.vehicle", "Vehicle (GuidLow: %u, DB Guid: %u, Entry %u): installing accessory (Entry: %u) on seat: %d",
...
bool Vehicle::AddPassenger(Unit* unit, int8 seatId)
{
    ...
    TC_LOG_INFO("entities.vehicle", "Unit %s scheduling enter vehicle (entry: %u, vehicleId: %u, guid: %u (dbguid: %u) on seat %d",
...
Vehicle* Vehicle::RemovePassenger(Unit* unit)
{
    ...
    TC_LOG_INFO("entities.vehicle", "Unit %s exit vehicle entry %u id %u dbguid %u seat %d",
...
void VehicleJoinEvent::Abort(uint64)
{
    ...
    if (Target)
    {
        TC_LOG_INFO("entities.vehicle", "Passenger GuidLow: %u, Entry: %u, board on vehicle GuidLow: %u, Entry: %u SeatId: %d cancelled",
        ...
        TC_LOG_INFO("entities.vehicle", "Passenger GuidLow: %u, Entry: %u, board on uninstalled vehicle SeatId: %d cancelled",
