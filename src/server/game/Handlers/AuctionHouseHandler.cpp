...
{
    TC_LOG_INFO("network", "WORLD: Received CMSG_AUCTION_HELLO");
    ...
    if (!unit)
    {
        TC_LOG_INFO("network", "WORLD: HandleAuctionHelloOpcode - Unit (GUID: %u) not found or you can't interact with him.", uint32(GUID_LOPART(guid)));
        return;
    }
...
void WorldSession::HandleAuctionSellItem(WorldPacket& recvData)
{
    ...
    {
        TC_LOG_INFO("network", "WORLD: HandleAuctionSellItem - Player %s (GUID %u) attempted to sell item with higher price than max gold amount.", _player->GetName().c_str(), _player->GetGUIDLow());
    ...
    if (!creature)
    {
        TC_LOG_INFO("network", "WORLD: HandleAuctionSellItem - Unit (GUID: %u) not found or you can't interact with him.", GUID_LOPART(auctioneer));
        return;
    }
    ...
    {
        TC_LOG_INFO("network", "WORLD: HandleAuctionSellItem - Unit (GUID: %u) has wrong faction.", GUID_LOPART(auctioneer));
        return;
    }
...
{
    TC_LOG_INFO("network", "WORLD: Received CMSG_AUCTION_PLACE_BID");
    ...
    if (!creature)
    {
        TC_LOG_INFO("network", "WORLD: HandleAuctionPlaceBid - Unit (GUID: %u) not found or you can't interact with him.", uint32(GUID_LOPART(auctioneer)));
        return;
    }
...
{
    TC_LOG_INFO("network", "WORLD: Received CMSG_AUCTION_REMOVE_ITEM");
    ...
    if (!creature)
    {
        TC_LOG_INFO("network", "WORLD: HandleAuctionRemoveItem - Unit (GUID: %u) not found or you can't interact with him.", uint32(GUID_LOPART(auctioneer)));
        return;
    }
...
{
    TC_LOG_INFO("network", "WORLD: Received CMSG_AUCTION_LIST_BIDDER_ITEMS");
    ...
    if (!creature)
    {
        TC_LOG_INFO("network", "WORLD: HandleAuctionListBidderItems - Unit (GUID: %u) not found or you can't interact with him.", uint32(GUID_LOPART(auctioneer)));
        recvData.rfinish();
        return;
    }
...
{
    TC_LOG_INFO("network", "WORLD: Received CMSG_AUCTION_LIST_OWNER_ITEMS");
    ...
    if (!creature)
    {
        TC_LOG_INFO("network", "WORLD: HandleAuctionListOwnerItems - Unit (GUID: %u) not found or you can't interact with him.", uint32(GUID_LOPART(auctioneer)));
        return;
    }
...
{
    TC_LOG_INFO("network", "WORLD: Received CMSG_AUCTION_LIST_ITEMS");
    ...
    if (!creature)
    {
        TC_LOG_INFO("network", "WORLD: HandleAuctionListItems - Unit (GUID: %u) not found or you can't interact with him.", uint32(GUID_LOPART(auctioneer)));
        return;
    }
    ...
    //TC_LOG_INFO("misc", "Auctionhouse search (GUID: %u TypeId: %u)",, list from: %u, searchedname: %s, levelmin: %u, levelmax: %u, auctionSlotID: %u, auctionMainCategory: %u, auctionSubCategory: %u, quality: %u, usable: %u",
...
{
    TC_LOG_INFO("network", "WORLD: Received CMSG_AUCTION_LIST_PENDING_SALES");
