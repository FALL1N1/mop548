...
void WorldSession::HandleLfgJoinOpcode(WorldPacket& recvData)
{
    ...
    if (!numDungeons)
    {
        TC_LOG_INFO("lfg", "CMSG_LFG_JOIN %s no dungeons selected", GetPlayerInfo().c_str());
        recvData.rfinish();
        return;
    }
    ...
    TC_LOG_INFO("lfg", "CMSG_LFG_JOIN %s roles: %u, Dungeons: %u, Comment: %s",
...
void WorldSession::HandleLfgLeaveOpcode(WorldPacket& recvData)
{
    ...
    TC_LOG_INFO("lfg", "CMSG_LFG_LEAVE %s in group: %u sent guid " UI64FMTD ".",
...
void WorldSession::HandleLfgProposalResultOpcode(WorldPacket& recvData)
{
    ...
    TC_LOG_INFO("lfg", "CMSG_LFG_PROPOSAL_RESULT %s proposal: %u accept: %u",
...
void WorldSession::HandleLfgSetRolesOpcode(WorldPacket& recvData)
{
    ...
    if (!group)
    {
        TC_LOG_INFO("lfg", "CMSG_LFG_SET_ROLES %s Not in group",
            GetPlayerInfo().c_str());
        return;
    }
    uint64 gguid = group->GetGUID();
    TC_LOG_INFO("lfg", "CMSG_LFG_SET_ROLES: Group %u, Player %s, Roles: %u",
...
void WorldSession::HandleLfgSetCommentOpcode(WorldPacket&  recvData)
{
    ...
    TC_LOG_INFO("lfg", "CMSG_LFG_SET_COMMENT %s comment: %s",
...
void WorldSession::HandleLfgSetBootVoteOpcode(WorldPacket& recvData)
{
    ...
    uint64 guid = GetPlayer()->GetGUID();
    TC_LOG_INFO("lfg", "CMSG_LFG_SET_BOOT_VOTE %s agree: %u",
...
void WorldSession::HandleLfgTeleportOpcode(WorldPacket& recvData)
{
    ...
    TC_LOG_INFO("lfg", "CMSG_LFG_TELEPORT %s out: %u",
...
void WorldSession::HandleLfgGetLockInfoOpcode(WorldPacket& recvData)
{
    ...
    TC_LOG_INFO("lfg", "CMSG_LFG_LOCK_INFO_REQUEST %s for %s", GetPlayerInfo().c_str(), (forPlayer ? "player" : "party"));
...
void WorldSession::SendLfgPlayerLockInfo()
{
    ...
    TC_LOG_INFO("lfg", "SMSG_LFG_PLAYER_INFO %s", GetPlayerInfo().c_str());
...
void WorldSession::SendLfgPartyLockInfo()
{
    ...
    TC_LOG_INFO("lfg", "SMSG_LFG_PARTY_INFO %s", GetPlayerInfo().c_str());
...
void WorldSession::HandleLfrJoinOpcode(WorldPacket& recvData)
{
    ...
    recvData >> entry;
    TC_LOG_INFO("lfg", "CMSG_LFG_LFR_JOIN %s dungeon entry: %u",
...
void WorldSession::HandleLfrLeaveOpcode(WorldPacket& recvData)
{
    ...
    recvData >> dungeonId;
    TC_LOG_INFO("lfg", "CMSG_LFG_LFR_LEAVE %s dungeonId: %u",
...
{
    TC_LOG_INFO("lfg", "CMSG_LFG_GET_STATUS %s", GetPlayerInfo().c_str());
...
void WorldSession::SendLfgUpdateStatus(lfg::LfgUpdateData const& updateData, bool party)
{
    ...
    TC_LOG_INFO("lfg", "SMSG_LFG_UPDATE_STATUS %s updatetype: %u, party %s",
...
{
    TC_LOG_INFO("lfg", "SMSG_LFG_ROLE_CHOSEN %s guid: %u roles: %u",
...
void WorldSession::SendLfgRoleCheckUpdate(lfg::LfgRoleCheck const& roleCheck)
{
    ...
    TC_LOG_INFO("lfg", "SMSG_LFG_ROLE_CHECK_UPDATE %s", GetPlayerInfo().c_str());
...
void WorldSession::SendLfgJoinResult(lfg::LfgJoinResultData const& joinData)
{
    ...
    TC_LOG_INFO("lfg", "SMSG_LFG_JOIN_RESULT %s checkResult: %u checkValue: %u",
...
{
    TC_LOG_INFO("lfg", "SMSG_LFG_QUEUE_STATUS %s dungeon: %u, waitTime: %d, "
...
void WorldSession::SendLfgPlayerReward(lfg::LfgPlayerRewardData const& rewardData)
{
    ...
    TC_LOG_INFO("lfg", "SMSG_LFG_PLAYER_REWARD %s rdungeonEntry: %u, sdungeonEntry: %u, done: %u",
...
void WorldSession::SendLfgBootProposalUpdate(lfg::LfgPlayerBoot const& boot)
{
    ...
    TC_LOG_INFO("lfg", "SMSG_LFG_BOOT_PROPOSAL_UPDATE %s inProgress: %u - "
...
void WorldSession::SendLfgUpdateProposal(lfg::LfgProposal const& proposal)
{
    ...
    TC_LOG_INFO("lfg", "SMSG_LFG_PROPOSAL_UPDATE %s state: %u",
...
{
    TC_LOG_INFO("lfg", "SMSG_LFG_LFR_LIST %s update: %u",
...
{
    TC_LOG_INFO("lfg", "SMSG_LFG_DISABLED %s", GetPlayerInfo().c_str());
...
{
    TC_LOG_INFO("lfg", "SMSG_LFG_OFFER_CONTINUE %s dungeon entry: %u",
...
{
    TC_LOG_INFO("lfg", "SMSG_LFG_TELEPORT_DENIED %s reason: %u",
...
{
    TC_LOG_INFO("network", "SMSG_LFG_UPDATE_LIST %s dungeon entry: %u",
        GetPlayerInfo().c_str(), dungeonEntry);
