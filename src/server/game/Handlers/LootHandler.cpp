...
{
    TC_LOG_INFO("network", "WORLD: CMSG_AUTOSTORE_LOOT_ITEM");
...
{
    TC_LOG_INFO("network", "WORLD: CMSG_LOOT_MONEY");
...
{
    TC_LOG_INFO("network", "WORLD: CMSG_LOOT");
...
{
    TC_LOG_INFO("network", "WORLD: CMSG_LOOT_RELEASE");
...
void WorldSession::HandleLootMasterGiveOpcode(WorldPacket& recvData)
{
    ...
    TC_LOG_INFO("network", "WorldSession::HandleLootMasterGiveOpcode (CMSG_LOOT_MASTER_GIVE, 0x02A3) Target = [%s].", target->GetName().c_str());
    ...
    {
        TC_LOG_INFO("loot", "MasterLootItem: Player %s might be using a hack! (slot %d, size %lu)",
