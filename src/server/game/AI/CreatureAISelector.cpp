...
namespace FactorySelector
{
    CreatureAI* selectAI(Creature* creature)
    {
        ...
        TC_LOG_INFO("scripts", "Creature %s (Entry: %u GUID: %u DB GUID: %u) is using AI type: %s.", creature->GetName().c_str(), creature->GetEntry(), creature->GetGUIDLow(), creature->GetDBTableGUIDLow(), ainame.c_str());
    ...
    GameObjectAI* SelectGameObjectAI(GameObject* go)
    {
        ...
        TC_LOG_INFO("scripts", "GameObject %u used AI is %s.", go->GetGUIDLow(), ainame.c_str());
