...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ACCEPT_TRADE,                       0x144D, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleAcceptTradeOpcode            );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CLEAR_RAID_MARKER,                  0x1443, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleClearRaidMarkerOpcode        ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(CMSG_DUEL_ACCEPTED,                      0x03E2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDuelAcceptedOpcode           ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(CMSG_DUEL_PROPOSED,                      0x1A26, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDuelProposedOpcode           ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ENABLETAXI,                         0x0741, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleTaxiQueryAvailableNodes      ); // Maby 0x02E3
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_CRITERIA_DATA,                0x1552, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestGuildCriteriaData     ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_SWITCH_RANK,                  0x0CD1, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGuildSwitchRankOpcode        ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_JOIN_CHANNEL,                       0x148E, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleJoinChannel                  ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LF_GUILD_ADD_APPLICATION,           0x0C63, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildFinderAddApplication    ); // 5.4.8 18291
    DEFINE_OPCODE_HANDLER(CMSG_LF_GUILD_REMOVE_APPLICATION,        0x1C53, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildFinderRemoveApplication ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LOOT_ROLL,                          0x0A3A, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleLootRoll                     );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_AFK,                    0x0EAB, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_CHANNEL,                0x00BB, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PET_ACTION,                         0x025B, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandlePetAction                    );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PING,                               0x0012, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess               ); // 5.4.8 18291 its 0x0012 but for some resone this messes up the servers ping/pong and the other sync's
    DEFINE_OPCODE_HANDLER(CMSG_PLAYED_TIME,                        0x03F6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePlayedTime                   ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY,   0x02F1, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverStatusMultipleQuery); // 5.4.8 18414 Might Be 0x02F1 or maby 0x0345 or 0x06E4
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REPOP_REQUEST,                      0x134A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRepopRequestOpcode           ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_RATED_STATS,                0x0375, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestRatedStats            ); //5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_TITLE,                          0x03C7, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetTitleOpcode               ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_TRADE_ITEM,                     0x03D5, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleSetTradeItemOpcode           );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SOCKET_GEMS,                        0x02CB, STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleSocketOpcode                 ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(CMSG_TEXT_EMOTE,                         0x07E9, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTextEmoteOpcode              ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(CMSG_TOGGLE_PVP,                         0x02C5, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTogglePvP                    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_UNACCEPT_TRADE,                     0x0023, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleUnacceptTradeOpcode          );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_VOID_STORAGE_UNLOCK,                0x0444, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::HandleVoidStorageUnlock            );
    ...
    DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_RUN_MODE,                   0x0979, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_WALK_MODE,                  0x08D1, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_RATED_INFO,             0x08AA, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CHANNEL_NOTIFY,                     0x0F06, STATUS_NEVER    ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CHAT_PLAYER_AMBIGUOUS,              0x061A, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_CHAT_PLAYER_NOT_FOUND,              0x1082, STATUS_NEVER    ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_COMPLETE,                      0x1C0A, STATUS_NEVER    ); // 5.4.8 18291
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_COUNTDOWN,                     0x129F, STATUS_NEVER    ); // 5.4.8 18291
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_INBOUNDS,                      0x163A, STATUS_NEVER    ); // 5.4.8 18291
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_OUTOFBOUNDS,                   0x001A, STATUS_NEVER    ); // 5.4.8 18291
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_REQUESTED,                     0x0022, STATUS_NEVER    ); // 5.4.8 18291
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_WINNER,                        0x10E1, STATUS_NEVER    ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(SMSG_EMOTE,                              0x0987, STATUS_NEVER    ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_BANK_BUY_TAB,                 0x1BE9, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_BANK_DEPOSIT_MONEY,           0x0F68, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_INVITE,                       0x0F71, STATUS_LOGGEDIN ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_HIGHEST_THREAT_UPDATE,              0x14AE, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LF_GUILD_APPLICATIONS_LIST_UPDATED, 0x0AE0, STATUS_NEVER    ); // 5.4.8 18291
    DEFINE_OPCODE_HANDLER(SMSG_LF_GUILD_APPLICATIONS_LIST_CHANGED, 0x1A70, STATUS_NEVER    ); // 5.4.8 18291
    DEFINE_OPCODE_HANDLER(SMSG_LF_GUILD_APPLICANT_LIST_UPDATED,    0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_LF_GUILD_APPLICANT_LIST_CHANGED,    0x0000, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UNSET_HOVER,                   0x0CE1, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PET_SLOT_UPDATED,                   0x069A, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_PET_SPELLS,                         0x095A, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_PET_TAME_FAILURE,                   0x040E, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PLAYERBOUND,                        0x1B60, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_RATED_STATS,                        0x0EBA, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_RESEARCH_COMPLETE,                  0x0C0E, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_RESEARCH_SETUP_HISTORY,             0x08AB, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SHOWTAXINODES,                      0x1E1A, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SOCKET_GEMS_RESULT,                 0x12A6, STATUS_NEVER    ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPELLINSTAKILLLOG,                  0x09F8, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_SPELLINTERRUPTLOG,                  0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_SPELLLOGEXECUTE,                    0x00D8, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FEATHER_FALL,       0x1893, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLIGHT_BACK_SPEED,  0x0B28, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLIGHT_SPEED,       0x1DAB, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLYING,             0x1046, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_HOVER,              0x0258, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_LAND_WALK,          0x18B6, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_NORMAL_FALL,        0x0B08, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_PITCH_RATE,         0x0AB3, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_RUN_BACK_SPEED,     0x1F9F, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_RUN_MODE,           0x0B18, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_SWIM_SPEED,         0x1D8E, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WALK_SPEED,         0x0469, STATUS_UNHANDLED); // Maby not correct
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WATER_WALK,         0x1823, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_START_SWIM,             0x0F29, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_STOP_SWIM,              0x1798, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNROOT,                 0x01E1, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNSET_FLYING,           0x0DE2, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNSET_HOVER,            0x0CE1, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TAXINODE_STATUS,                    0x169E, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_TEST_DROP_RATE_RESULT,              0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_TEXT_EMOTE,                         0x002E, STATUS_NEVER    ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TITLE_EARNED,                       0x068E, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TRADE_STATUS,                       0x1963, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_TRADE_STATUS_EXTENDED,              0x181E, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_TRAINER_BUY_FAILED,                 0x042E, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(MSG_CHANNEL_START,                       0x10F9, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(MSG_CHANNEL_UPDATE,                      0x11D9, STATUS_NEVER    ); // 5.4.8 18414
