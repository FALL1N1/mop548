...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_COMPLETE,                      0x1C0A, STATUS_UNHANDLED); // 5.4.8 18291
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_COUNTDOWN,                     0x129F, STATUS_UNHANDLED); // 5.4.8 18291
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_INBOUNDS,                      0x163A, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_OUTOFBOUNDS,                   0x001A, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_REQUESTED,                     0x0022, STATUS_UNHANDLED); // 5.4.8 18291
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_WINNER,                        0x10E1, STATUS_UNHANDLED); // 5.4.8 18291
