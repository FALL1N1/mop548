...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SPLINE_GRAVITY_DISABLE,             0x0845, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SPLINE_GRAVITY_ENABLE,              0x0865, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SPLINE_ROOT,                        0x0728, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SPLINE_SET_SWIM_BACK_SPEED,         0x0046, STATUS_UNHANDLED); // 5.4.8 18414, Maybe not correct
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SPLINE_SET_WALK_BACK_SPEED,         0x08B2, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SPLINE_UNSET_HOVER,                 0x0CE1, STATUS_UNHANDLED); // 5.4.8 18414
