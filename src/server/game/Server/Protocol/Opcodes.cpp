...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LFG_JOIN,                           0x46B,  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgJoinOpcode                ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_AFK,                    0xEAB,  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_DND,                    0x2E,   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            );
