...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_QUERY_NAME,              0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetQueryName           ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PING,                               0x0012, STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess               ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY,   0x0345, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverStatusMultipleQuery); // 5.4.8 18414 Might Be 0x02F1 or maby 0x0345 or 0x06E4
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_COUNTDOWN,                     0x10C2, STATUS_NEVER    ); // 5.4.8 18291
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GAMEOBJECT_CUSTOM_ANIM,             0x001F, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GAMEOBJECT_RESET_STATE,             0x100E, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_THREAT_CLEAR,                       0x180B, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_THREAT_REMOVE,                      0x1960, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_THREAT_UPDATE,                      0x0632, STATUS_UNHANDLED);
