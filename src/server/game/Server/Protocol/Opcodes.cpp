...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ONLINE_SHOP_QUERY,                         0x0DE0, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleOnlineShopQueryOpcode        ); // 5.4.8 18414
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ADD_RUNE_POWER,                          0x1860, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_DELETED,                      0x18AB, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_RATED_INFO,                  0x0EBA, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CHAT_SERVER_RECONNECTED,                 0x0A2E, STATUS_UNHANDLED); // 5.4.8 18141
    DEFINE_OPCODE_HANDLER(SMSG_CHAT_WRONG_FACTION,                      0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_CLEAR_BOSS_EMOTES,                       0x062B, STATUS_UNHANDLED); // 5.4.8 18141
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CONVERT_RUNE,                            0x1A1B, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GMRESPONSE_RECEIVED,                     0x129B, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GMTICKET_SYSTEMSTATUS,                   0x148E, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_INSPECT_TALENT,                          0x1842, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LEARN_TALENT_FAILED,                     0x041E, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ONLINE_SHOP_QUERY_RESULT,                0x1ABF, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SEND_ITEM_UPGRADE,                       0x0E33, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_GRAVITY_DISABLE,             0x0845, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_GRAVITY_ENABLE,              0x0865, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNSET_HOVER,                 0x0CE1, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_STABLE_LIST,                             0x1613, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_INSTANCE_OWNERSHIP,               0x10E0, STATUS_UNHANDLED); // 5.4.8 18414
