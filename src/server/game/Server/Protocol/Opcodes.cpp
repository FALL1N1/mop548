...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BINDER_ACTIVATE,                           0x1248, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBinderActivateOpcode         ); // 5.4.8 18414 todo crashfix
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PET_SET_ACTION,                            0x12E9, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetSetAction                 ); // 5.4.8 18414  Or maby        0x12E9 Not sure if this function is used anymore        0x149B
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_LOOT_SPECIALIZATION,                   0x1260, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetLootSpecializationOpcode  ); // 5.4.8 18519
    ...
    DEFINE_OPCODE_HANDLER(CMSG_UPDATE_ACCOUNT_DATA,                       0x0068, STATUS_LOGGEDIN,    PROCESS_THREADUNSAFE, &WorldSession::HandleUpdateAccountData            ); // 5.4.8 18414 STATUS_AUTHED (@todo, crashfix)
    ...
    DEFINE_OPCODE_HANDLER(MSG_LIST_STABLED_PETS,                          0x02CA, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleListStabledPetsOpcode        ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GET_MIRRORIMAGE_DATA,                      0x02A3, STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleMirrorImageDataRequest       ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GMTICKET_CREATE,                           0x1A86, STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::HandleGMTicketCreateOpcode          ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(CMSG_GMTICKET_GETTICKET,                        0x1F89, STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketGetTicketOpcode       ); // 5.4.8 18414  0x1F89 0xA0B6
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GMTICKET_SYSTEMSTATUS,                     0x15A8, STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketSystemStatusOpcode   ); 
    DEFINE_OPCODE_HANDLER(CMSG_GMTICKET_UPDATETEXT,                       0x03A4, STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketUpdateOpcode         );  // 5.4.8 18414
    
    DEFINE_OPCODE_HANDLER(CMSG_PET_ABANDON,                               0x07D0, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandlePetAbandon                   );
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_EQUIPMENT_SET_LIST,                      0x18E2, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_EQUIPMENT_SET_SAVED,                     0x0006, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GM_TICKET_RESPONSE_ERROR,                0x009B, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_GM_TICKET_STATUS_UPDATE,                 0x000B, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_GM_TICKET_SYSTEM_STATUS,                 0x163B, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_GM_TICKET_SYSTEMSTATUS,                  0x148E, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_GM_TICKET_UPDATE,                        0x02A6, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_GM_RESPONSE_RECEIVED,                    0x129B, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_GM_RESPONSE_DB_ERROR,                    0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GM_RESPONSE_STATUS_UPDATE,               0x03A6, STATUS_NEVER); // not sure??
    DEFINE_OPCODE_HANDLER(SMSG_GM_TICKET_CREATE,                        0x1A8A, STATUS_NEVER); // not sure?? 0x1A8A
    DEFINE_OPCODE_HANDLER(SMSG_GM_TICKET_DELETETICKET,                  0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GM_TICKET_GETTICKET,                     0x03A5, STATUS_NEVER); // not sure??
    
    // #todo
    DEFINE_OPCODE_HANDLER(SMSG_OPEN_LFG_DUNGEON_FINDER,                 0x0E8A, STATUS_NEVER); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_CUSTOMIZE,                          0x1432, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_RENAME,                             0x0CBF, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DEBUG_RUNE_REGEN,                        0x12A7, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ENCHANTMENT_LOG,                         0x12A3, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MIRRORIMAGE_DATA,                        0x04D9, STATUS_NEVER); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_OVERRIDE_LIGHT,                          0x068A, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PET_ADDED,                               0x123A, STATUS_NEVER); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_ACTION,                       0x0C1A, STATUS_NEVER); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_MAX_GAME_LENGHT_WARNING,      0x022B, STATUS_NEVER); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PET_GOD_MODE,                            0x1940, STATUS_NEVER); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_PET_NAME_INVALID,                        0x028E, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_PLAY_MUSIC,                              0x0023, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PROPOSE_LEVEL_GRANT,                     0x109A, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_REFER_A_FRIEND_FAILURE,                  0x021E, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_RESURRECT_REQUEST,                       0x1062, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_RESYNC_RUNES,                            0x15E3, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SERVER_FIRST_ACHIEVEMENT,                0x028B, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SET_FACTION_NOT_VISIBLE,                 0x1C2B, STATUS_UNHANDLED); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SET_ITEM_CHALLENGE_MODE_DATA,            0x0A3B, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SUMMON_REQUEST,                          0x081F, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TRANSFER_ABORTED,                        0x0C8F, STATUS_UNHANDLED); // 5.4.8 18414
