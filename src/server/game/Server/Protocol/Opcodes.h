...
enum Opcodes
{
    ...
    CMSG_MOVE_SET_CAN_TRANS_BETW_SWIM_AND_FLY_ACK,
    ...
    SMSG_MOVE_UNSET_CAN_TRANS_BETW_SWIM_AND_FLY,
    ...
    SMSG_PET_RENAMEABLE,
    SMSG_PET_SET_TALENT, // SetPetSpecialization
    ...
    SMSG_SPLINE_MOVE_SET_WALK_BACK_SPEED,
