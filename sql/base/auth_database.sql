...
-- Dumping structure for table 548_auth.account
...
-- Dumping structure for table 548_auth.account_access
...
-- Dumping structure for table 548_auth.account_banned
...
-- Dumping structure for table 548_auth.autobroadcast
...
-- Dumping structure for table 548_auth.bug_tickets
...
-- Dumping structure for table 548_auth.ip2nation
...
-- Dumping structure for table 548_auth.ip2nationcountries
...
-- Dumping structure for table 548_auth.ip_banned
...
-- Dumping structure for table 548_auth.logs
...
-- Dumping structure for table 548_auth.rbac_account_permissions
...
-- Dumping structure for table 548_auth.rbac_default_permissions
...
-- Dumping structure for table 548_auth.rbac_linked_permissions
...
-- Dumping structure for table 548_auth.rbac_permissions
...
-- Dumping structure for table 548_auth.realmcharacters
...
-- Dumping structure for table 548_auth.realmlist
...
-- Dumping structure for table 548_auth.realm_classes
...
-- Dumping structure for table 548_auth.realm_races
...
-- Dumping structure for table 548_auth.uptime
...
/*!40014 SET @OLD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0 */;
/*!40101 SET @OLD_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO' */;
-- Dumping data for table 548_auth.rbac_account_permissions: ~0 rows (approximately)
...
-- Dumping data for table 548_auth.rbac_default_permissions: ~4 rows (approximately)
...
-- Dumping data for table 548_auth.rbac_linked_permissions: ~598 rows (approximately)
...
-- Dumping data for table 548_auth.rbac_permissions: ~615 rows (approximately)
...
-- Dumping data for table 548_auth.realm_classes: ~11 rows (approximately)
DELETE FROM `realm_classes`;
...
-- Dumping data for table 548_auth.realm_races: ~15 rows (approximately)
DELETE FROM `realm_races`;
