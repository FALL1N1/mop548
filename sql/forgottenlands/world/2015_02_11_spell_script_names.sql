...
DELETE FROM spell_script_names WHERE ScriptName IN ('spell_warr_heroic_leap_damage', 'spell_warr_heroic_leap', 'spell_warr_colossus_smash', 'spell_warr_second_wind',  'spell_warr_glyph_of_hindering_strikes', 'spell_warr_charge', 'spell_warr_glyph_of_hamstring', 'spell_warr_staggering_shout');
