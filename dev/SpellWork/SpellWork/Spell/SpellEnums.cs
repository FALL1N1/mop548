...
namespace TimelessWork.Spell
{
    ...
    */ 
    ...
    public enum SpellEffects
    {
        ...
        SPELL_EFFECT_183                              = 183, // Unused (5.4.8)
        SPELL_EFFECT_REPUTATION_REWARD                = 184,
        SPELL_EFFECT_185                              = 185,
        SPELL_EFFECT_186                              = 186, // 2 spells
        SPELL_EFFECT_RANDOM_DIGSITE                   = 187, // 1 spell
        SPELL_EFFECT_STAMPEDE                         = 188, // 1 spell
        SPELL_EFFECT_PUSH_LOOT                        = 189,
    ...
    public enum Targets
    {
        ...
        TARGET_UNK_137                     = 137, // 2 spells
        TARGET_UNK_138                     = 138,
        TARGET_UNK_139                     = 139, // 2 spells
        TARGET_UNK_140                     = 140,
        TARGET_UNK_141                     = 141,
        TARGET_UNK_142                     = 142,
        TARGET_UNK_143                     = 143, // 2 spells
        TOTAL_SPELL_TARGETS
    };
    ...
    public enum ShapeshiftFormMask : uint
    {
        ...
        FORM_WISE_SERPENT       = 0x00080000,   // 20
        FORM_ZOMBIE             = 0x00100000,   // 21
        FORM_METAMORPHOSIS      = 0x00200000,   // 22
        FORM_STURDY_OX          = 0x00400000,   // 23
        FORM_FIERCE_TIGER       = 0x00800000,   // 24
