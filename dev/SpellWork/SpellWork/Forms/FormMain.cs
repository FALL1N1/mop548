...
using TimelessWork.Extensions;
using TimelessWork.Spell;

namespace TimelessWork.Forms
{
    public sealed partial class FormMain : Form
    {
        public FormMain()
        {
            ...
            _tbSearchId.AutoCompleteMode = AutoCompleteMode.SuggestAppend;
            AutoCompleteStringCollection autoCompleteData = new AutoCompleteStringCollection();
            string[] spellNames = DBC.DBC.SpellInfoStore.Select(spell => spell.Value.SpellName).ToArray();
            autoCompleteData.AddRange(spellNames);
            _tbSearchId.AutoCompleteSource = AutoCompleteSource.CustomSource;
            _tbSearchId.AutoCompleteCustomSource = autoCompleteData;
        ...
        {
            e.Item =
                new ListViewItem(new[] { _spellProcList[e.ItemIndex].ID.ToString(), _spellProcList[e.ItemIndex].SpellNameRank });
        }
