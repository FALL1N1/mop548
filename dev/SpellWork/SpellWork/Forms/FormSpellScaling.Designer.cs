namespace TimelessWork.Forms
{
    partial class FormSpellScaling
    {
        ...
        {
            this.SelectedLevel = DBC.DBC.SelectedLevel;
            ...
            this._tbxLevel.Text = this.SelectedLevel.ToString();
            ...
            this._tbLevel.Size = new System.Drawing.Size(226, 42);
            this._tbLevel.TabIndex = 3;
            this._tbLevel.TickFrequency = 5;
            this._tbLevel.Value = (int)SelectedLevel;
